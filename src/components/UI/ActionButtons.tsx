...
export function ActionButtons({ onClear, onCopy, showQuestion, question, response }: ActionButtonsProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mt-4 animate-fadeIn">
      ...
      <button
        ...
        `}
        title={showConfirm ? "Clique novamente para confirmar" : "Limpar resposta"}
      >
        {showConfirm ? (
          <>
            <AlertCircle size={16} />
